...
logger = logging.getLogger("noisefloor.judges")
...
class LiveLLMJudge:
    ...
    def evaluate_correctness(self, question: str, response: str) -> float:
        ...
        if self.provider == "openrouter":
            headers["HTTP-Referer"] = "https://noisefloor.ai"
            headers["X-Title"] = "Noisefloor RiskLayer"
        ...
        try:
            ...
            logger.error(f"Live LLM Evaluation failed: {str(e)}")
